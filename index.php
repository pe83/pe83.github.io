...
<body>
<br>
<h1 id=msgs style='font-size:35px;text-align:center;color:#FFE4B5'>PS3 & PS4 Exploit Menu By Ali Madhi</h1>
<br>
...
<h1 style='font-size:25px;margin:auto;color:#FFE4B5'>Install PS4 Exploit Menu to the PS4 Browser (WWW)</h1>
<span class="br2"></span> 
...
<button onMouseOver="msgs.innerHTML='PS4 9.00A'"; onmouseout="msgs.innerHTML='PS3 & PS4 Exploit Menu By Ali Madhi'" onclick="location.replace('https://ps4900a.herokuapp.com/index.html');">9.00A</button>
<!--<button onMouseOver="msgs.innerHTML='PS4 9.00B'"; onmouseout="msgs.innerHTML='PS3 & PS4 Exploit Menu By Ali Madhi'" onclick="location.replace('https://ps4900b.herokuapp.com');">9.00B</button>-->
<br><br>
<h1 style='font-size:25px;margin:auto;color:#FFE4B5'>Restore Exploit Menu to User's Guide.<br> Settings > User's Guide > User's Guide.</h1>
<span class="br2"></span> 
...
<br><br>
<h1 style='font-size:25px;margin:auto;color:#FFE4B5'>PS3 Exploit (HEN and CFW)</h1>
<span class="br2"></span> 
<button onMouseOver="msgs.innerHTML='PS3 Xploit'"; onmouseout="msgs.innerHTML='PS3 & PS4 Exploit Menu By Ali Madhi'" onclick="location.replace('https://pe83.herokuapp.com');">PS3 Expliot</button>
</div>
<footer>
<div ><h2 class="linear-wipe">
		الشرق لتجارة الوسائل الترفيهية<br>
		عالم الغد علي ماضي 2020
		</h2></div>
</footer>
</body>
</html>
